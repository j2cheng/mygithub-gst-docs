...
gst_android_init (JNIEnv * env, jobject context)
{
  ...
  __android_log_print (ANDROID_LOG_ERROR, "GStreamer",
                       "gst_android_init in gstramer_android.c");
  ...
  __android_log_print (ANDROID_LOG_ERROR, "GStreamer",
        "gst_android_init: %p",cache_dir);//Crestron change

  //g_setenv("GST_DEBUG", "*:5", TRUE); //Crestron change
...
JNI_OnLoad (JavaVM * vm, void * reserved)
{
  ...
  GModule *module;
  __android_log_print (ANDROID_LOG_ERROR, "GStreamer",
                       "JNI_OnLoad in gstramer_android.c");
  ...
  __android_log_print (ANDROID_LOG_ERROR, "GStreamer",
                       "JNI_OnLoad return JNI_VERSION_1_4 in gstramer_android.c");
